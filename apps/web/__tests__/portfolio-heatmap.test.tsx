...
function comp(over: Partial<Composition> = {}): Composition {
  return {
    ...
    holdings: [
      ...
      { figi: "F2", ticker: "TSLA", name: "Tesla", sector: "Tech", industry: null, weight: -0.3, currency: "USD", price: 90, live_return: -0.02, freshness: "live" },
      { figi: "F3", ticker: "XYZ", name: "NoMap", sector: "Energy", industry: null, weight: 0.1, currency: null, price: null, live_return: null, freshness: "unavailable" },
    ],
    sectors: [
