...
function comp(over: Partial<Composition> = {}): Composition {
  return {
    ...
    holdings: [
      ...
      { figi: "F2", ticker: "TSLA", name: "Tesla", sector: "Tech", industry: null, mic: "XNAS", country: "US", status: "active", weight: -0.3, currency: "USD", market_cap_usd: 1e9, volume: 1000, price: 90, live_return: -0.02, window_returns: {}, freshness: "live" },
      { figi: "F3", ticker: "XYZ", name: "NoMap", sector: "Energy", industry: null, mic: null, country: null, status: null, weight: 0.1, currency: null, market_cap_usd: null, volume: null, price: null, live_return: null, window_returns: {}, freshness: "unavailable" },
    ],
    sectors: [
