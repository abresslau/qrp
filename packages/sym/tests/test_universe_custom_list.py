...
from sym.identity.universe import SeedSecurity, load_seed_universe
from sym.universe.providers.custom_list import CustomListProvider, member_token
from sym.universe.registry import CUSTOM_LIST, JOIN, is_registered


def _seed(ticker="AAPL", mic="XNAS", isin="US0378331005"):
    return SeedSecurity("Apple", "forward_split", ticker, mic, isin, None)


def test_custom_list_provider_is_registered():
    import sym.universe.providers  # noqa: F401  (triggers registration)
