"""psycopg connections for the rates package.
...
import — this package is standalone-shaped (the `macro` pattern). Override the database with
``RATES_DATABASE_URL`` (whole DSN) or rename it with ``RATES_DB_NAME``.
"""
