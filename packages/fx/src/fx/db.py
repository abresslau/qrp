"""psycopg connections for the fx package.
...
import — this package is standalone-shaped (the `rates`/`commodities` pattern). Override the
database with ``FX_DATABASE_URL`` (whole DSN) or rename it with ``FX_DB_NAME``.
"""
