...
from universe.registry import MembershipChange, validate_change, validate_precision
...
def append_change(
    ...
    *,
    ...
    from universe.resolution import _parse_token  # lazy: avoids identity-layer import cost
